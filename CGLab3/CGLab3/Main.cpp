...
struct Texture
{
	const GLchar* fileImageName;		// Имя файла с картинкой
...
{
	Texture("1.jpg", "u_map1", 0),
	Texture("2.jpg", "u_map2", 1)
};
...
{ 
	...
	glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, texW, texH, 0, GL_BGRA, GL_UNSIGNED_BYTE, imageData);
...
void initTextures()
{
	...
	{
		createTexture(textures[i].fileImageName, texIDs[i]);
